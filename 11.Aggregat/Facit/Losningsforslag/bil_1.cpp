...
int main()
{
  ...
  // Tävlingen slutar då någon av dem har slut på alla däck!
  ...
  if ( antVolvo + antSaab == 8 ) 
    {
      cout << "Ingen vinnare, båda har slut på gummi" 
	   << endl;
    }
  else if ( antVolvo == 4 )
    {
...
int bil::gaspaadrag( double d )
{
  ...
  // föraren gör.
  // Parameter: d = däckslitage-konstant
...
Bil av typen = Volvo     har  däck = 11.4 däck = 9.9
Bil av typen = Saab      har  däck = 12.5 däck = 11.2
Liten pause innan nästa gaspådrag... (tryck return).

Bil av typen = Volvo     har  däck = 0.6 däck = 0.0
Bil av typen = Saab      har  däck = 8.3 däck = 6.4
Liten pause innan nästa gaspådrag... (tryck return).

Bil av typen = Volvo     har  däck = 0.0 däck = 0.0
Bil av typen = Saab      har  däck = 1.7 däck = 0.0
Liten pause innan nästa gaspådrag... (tryck return).

-----Slutresultat: 
Vinnare är den som har däck kvar:
Bil av typen = Saab      har  däck = 1.7 däck = 0.0
Tack och hej!
 */
